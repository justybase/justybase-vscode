...
import {
  ...
  type DesignerTab,
} from './objectDesigner/model';
import { useObjectDesignerController } from './objectDesigner/useObjectDesignerController';
...
function ObjectDesigner({ connectionId, database, databaseKind, target, onClose, onApplied }: ObjectDesignerProps): ReactElement {
  ...
  } = useObjectDesignerController({ connectionId, database, databaseKind, target, onApplied });
