...
class SqlLanguageFeatureRegistry {
  ...
  public register(editor: Monaco.editor.IStandaloneCodeEditor, api: ApiClient, getContext: () => SqlLanguageContext, getPreferences: () => EditorPreferences | null): SqlModelRegistration {
