...
const defaultCapabilities: readonly CapabilityDescriptor[] = [
  ...
  { key: 'metadata', status: 'available', owner: 'electron-api-adapter', documentation: 'Authenticated schema tree, search, columns and dialect-qualified navigation.', removalCondition: 'Keep the shared metadata presentation.' },
  { key: 'history', status: 'available', owner: 'electron-api-adapter', documentation: 'Profile-scoped query history from the authenticated API.', removalCondition: 'Keep the shared history presentation.' },
  { key: 'explain', status: 'available', owner: 'electron-api-adapter', documentation: 'Explain execution through the authenticated query API.', removalCondition: 'Keep the shared Explain workflow.' },
  { key: 'designer', status: 'read-only', owner: 'electron-api-adapter', reason: 'DDL inspection is available; guarded designer apply remains capability-gated.', documentation: 'Dialect-aware metadata DDL and designer contracts.', removalCondition: 'Wire guarded DesignerPort preview/apply actions.' },
