...
const defaultCapabilities: readonly CapabilityDescriptor[] = [
  ...
  { key: 'designer', status: 'available', owner: 'electron-api-adapter', documentation: 'Dialect-aware metadata DDL plus guarded designer preview/apply workflows.', removalCondition: 'Keep designer capability and metadata-refresh gates aligned.' },
