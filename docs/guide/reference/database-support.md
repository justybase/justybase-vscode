...
| MySQL | Preview companion runtime (`8.0+` scope) | MySQL parser profile, completion, formatting, diagnostics | Metadata, DDL, object search, index/partition catalog views | Explain, Alter Table Designer, Index Designer, and method-specific Partition Manager | Provider-specific import/export and guarded table-structure operations | Preview; MariaDB and advanced partition restructuring outside scope |
...
target allowlist, reverse-proxy configuration, and live PostgreSQL/Netezza
checks, see the [global database tunnel guide](../../database-tunnel.md).
