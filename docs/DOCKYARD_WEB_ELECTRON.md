...
3. In Schema, use search and the object context menu for Select Top 1000,
   Explain plan, View/Edit Data (Limit 50k), Copy DDL, Create DDL Code,
   Object Designer, Import Data, and Refresh Selected Metadata. After
