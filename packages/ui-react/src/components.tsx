...
export function SchemaTree({ nodes, selectedId, expandedIds, onToggle, onSelect, onActivate, onInsert, onOpenQuery, onOpenExplain, onOpenDesigner, onOpenDdl, onCopyDdl, onImport, onCopyName, onToggleFavorite, isFavorite, favorites = [], recent = [], searchValue = '', onSearchChange, searchResults = [], searchLoading = false, searchPlaceholder = 'Search tables, views…', filters = [], activeFilterIds = [], onFilterToggle, onRefresh, onExpandAll, onCollapseAll }: SchemaTreeProps): ReactNode {
