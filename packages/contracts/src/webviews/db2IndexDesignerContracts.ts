/** Shared Db2 index designer message and data contracts. */
...
export type Db2IndexDesignerInboundMessage = Db2IndexDesignerWebviewToHostMessage;
export type Db2IndexDesignerOutboundMessage = Db2IndexDesignerHostToWebviewMessage;
