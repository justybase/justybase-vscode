...
const OPTIONAL_DIALECT_EXPECTATIONS = [
  {
    ...
    installHint:
      'Install the optional "JustyBase SQL Editor (DuckDB)" extension to use DuckDB connections.',
  },
  {
    kind: "db2" as const,
    installHint:
      'Install the optional "JustyBase SQL Editor (Db2)" extension to use Db2 connections.',
  },
  {
    kind: "oracle" as const,
    installHint:
      'Install the optional "JustyBase SQL Editor (Oracle)" extension to use Oracle connections.',
  },
  {
    kind: "vertica" as const,
    installHint:
      'Install the optional "JustyBase SQL Editor (Vertica)" extension to use Vertica connections.',
  },
  {
    kind: "postgresql" as const,
    installHint:
      'Install the optional "JustyBase SQL Editor (PostgreSQL)" extension to use PostgreSQL connections.',
  },
  {
    kind: "mssql" as const,
    installHint:
      'Install the optional "JustyBase SQL Editor (MS SQL Server)" extension to use MS SQL Server connections.',
  },
  {
    kind: "mysql" as const,
    installHint:
      'Install the optional "JustyBase SQL Editor (MySQL)" extension to use MySQL connections.',
  },
] as const;
