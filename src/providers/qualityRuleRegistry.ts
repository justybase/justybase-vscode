...
export const DIAGNOSTIC_OWNERSHIP: Record<string, DiagnosticOwnership> = {
  ...
  NZ004: { owner: "parser", parserCode: "SQL051", quickFix: "unsafe" },
  NZ010: { owner: "parser", parserCode: "SQL052", quickFix: "unsafe" },
  NZ016: { owner: "parser", parserCode: "SQL053", quickFix: "none" },
