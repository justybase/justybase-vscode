import type { PostgresqlAlterTableDesignerColumn } from './postgresqlAlterTableDesignerContracts';

export type { PostgresqlAlterTableDesignerColumn as PostgresqlDesignerColumn };
...
export type PostgresqlIndexDesignerInboundMessage = PostgresqlIndexDesignerWebviewToHostMessage;
export type PostgresqlIndexDesignerOutboundMessage = PostgresqlIndexDesignerHostToWebviewMessage;