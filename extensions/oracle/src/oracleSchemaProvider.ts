...
export const oracleMetadataProvider = createDelegatingMetadataProvider({
    ...
    listSourceObjects: (_database, schema) => buildListSourceObjectsQuery(schema),
    synonymTarget: (_database, synonymName, schema) => buildSynonymTargetQuery(_database, synonymName, schema),
